...
"""
╔══════════════════════════════════════════════════════════════════════════════╗
║                        SYMBOL DELETE TASK GENERATION                          ║
║                                                                               ║
║  Generate symbol deletion tasks for visual reasoning.                         ║
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate symbol deletion task dataset",
...
Examples:
    ...
    parser.add_argument(
        ...
        type=int,
        required=True,
        help="Number of symbol deletion task samples to generate"
    )
    parser.add_argument(
        "--symbol-set",
        type=str,
    ...
    parser.add_argument(
        ...
        type=int,
        default=5,
        help="Minimum sequence length before deletion (default: 5)"
    )
    parser.add_argument(
        "--max-length",
        type=int,
        default=9,
        help="Maximum sequence length before deletion (default: 9)"
    )
    parser.add_argument(
        "--output",
        type=str,
    ...
    print(f"🗑️  Generating {args.num_samples} symbol deletion tasks...")
    ...
    # Configure symbol deletion task generation
    config = TaskConfig(
